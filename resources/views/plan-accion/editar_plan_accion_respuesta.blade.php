...
<body>
    <div class="container-fluid">
        ...
        <section class="container">
            <header>8. Plan de acción</header>
            <div class="d-flex justify-content-end mb-6">
                <div class="input-group">
                    <span class="input-group-text" id="basic-addon1">
                        <i class="fa-solid fa-plus"></i>
                    </span>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#crearActividadModal" id="crearRespuesta" disabled>
            ...
            <form action="#" class="form">
                            ...
                            @foreach ($actividad as $item)
                                <tr>
                                    ...
                                    <td class="d-flex gap-2">
                                        <button type="button" class="btn btn-warning btn-sm editarRespuesta"
                                            data-bs-toggle="modal" data-bs-target="#editarRespuestaModal"
                                        ...
                                        <button type="button" class="btn btn-outline-danger btn-sm eliminarRespuesta"
                                            data-bs-toggle="modal" data-bs-target="#modalDelete"
                                            data-cod_respuesta="{{ $item->cod_respuesta }}" disabled>Eliminar
                ...
                <div class="row botonsform">
                    <div class="col">
                        ...
                        <a href="{{ url('/plan_accion_recuperacion/visualizar/' . $item->cod_familia) }}"
        ...
        <div class="modal-dialog">
            <form id="actividadForm" class="form" method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="actividad" class="form-label fw-bold">¿Cómo actuamos durante la
                                emergencia?</label>
    ...
    <div class="modal fade" id="editarRespuestaModal" data-bs-backdrop="static" tabindex="-1"
        aria-labelledby="editarRespuestaLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form id="editarRespuestaForm" class="form" method="PUT" autocomplete="off">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fw-bold fs-5" id="crearProyectoLabel">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const respuestaButton = document.getElementById('crearRespuesta');
            ...
            editarButton.addEventListener('click', () => {
                ...
                respuestaButton.disabled = false;
    ...
    <script>
        ...
        document
            ...
            .addEventListener("submit", async function(event) {
                ...
                try {
                    const response = await fetch("/plan_accion_respuesta", { // Ruta actualizada aquí
                        method: "POST",
                        headers: {
    ...
    <script>
        document.getElementById('editarRespuestaModal').addEventListener('show.bs.modal', function(event) {
        ...
        document.getElementById('editarRespuestaForm').addEventListener('submit', async function(event) {
