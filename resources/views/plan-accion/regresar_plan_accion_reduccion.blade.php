        ...
        <section class="container">
            ...
            <div class="d-flex justify-content-end mb-6">
                <div class="input-group">
                    ...
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#crearActividadModal" id="crearReduccion" >
            ...
            <form action="#" class="form">
                ...
                <div class="row botonsform">
                    <div class="col">
                        ...
                        <a href="{{ url('/recursos_familiares_disponibles/editar/' . $item->cod_familia) }}"
                            class="btn btn-secondary">Regresar <i class="fa-solid fa-rotate-left"></i></a>
                        <a href="{{ url('/plan_accion_respuesta/editar/' . $item->cod_familia) }}" class="btn btn-success">Siguiente
