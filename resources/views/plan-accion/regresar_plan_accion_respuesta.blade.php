        ...
        <section class="container">
            ...
            <div class="d-flex justify-content-end mb-6">
                <div class="input-group">
                    ...
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#crearActividadModal" id="crearRespuesta">
            ...
            <form action="#" class="form">
                ...
                <div class="row botonsform">
                    <div class="col">
                        ...
                        <a href="{{ url('/plan_accion_recuperacion/editar/' . $item->cod_familia) }}"
