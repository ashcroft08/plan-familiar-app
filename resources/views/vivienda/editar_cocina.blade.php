                        ...
                        <tbody>
                            @foreach ($cocina as $fila)
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="form-control"name="acciones_{{ $fila->cod_cocina }}" disabled>{{ $fila->acciones }}</textarea>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ url('bano/visualizar/' . $cocina->first()->cod_familia) }}" class="btn btn-primary">Aceptar <i class="fa-solid fa-check"></i></a>
                </div>
            </div>
        </div>
    </div>
