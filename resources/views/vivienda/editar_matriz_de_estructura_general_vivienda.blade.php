                    ...
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb float-md-end">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    Matriz de estructura general de la
                                    vivienda
                                </li>
                            </ol>
                        </nav>
                        ...
                        <tbody>
                            @foreach ($estructuraVivienda as $fila)
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="form-control"name="acciones_{{ $fila->cod_estructura_vivienda }}" disabled>{{ $fila->acciones }}</textarea>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        document.getElementById('estructuraViviendaForm').addEventListener('submit', async (event) => {
            ...
            try {
                ...
                if (responseData.success) {
                    ...
                    window.location.href = `/comedor/visualizar/${cod_familia}`;
                } else {
                    alert(
